...
function Sidebar() {
  const [channels] = useCollection(db.collection("rooms")); //Make a new collecetion inside firebase
  const [user] = useAuthState(auth); //Firebase hooks is used here to provide state of auth
